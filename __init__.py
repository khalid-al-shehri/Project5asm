...
engine = create_engine('sqlite:///shopcatalog.db?check_same_thread=False')
Base.metadata.bind = engine
...
def catalogindex():
    catalogindex = session.query(Catalog)
    return render_template('catalog.html', catalog=catalogindex )
...
def editItem(catalog_id, item_id):
    ...
    if editItem.user_id == login_session['user_id']:
	    ...
	    return redirect(url_for('catalog', catalog_id=catalog_id))
		    ...
		    return render_template('editItem.html', catalog_id=catalog_id, item_id = item_id, item = editItem)
    else:
        flash("You can edit only the Item you create it")
        return redirect(url_for('catalog', catalog_id=catalog_id))
...
def deleteItem(catalog_id, item_id):
    ...
    if deleteItem.user_id != login_session['user_id']:
        flash("You can delete only the Item you create it")
        return redirect(url_for('catalog', catalog_id=catalog_id))
